...
episodes, and deepening the TCA run beyond its price vector, is a
parameter reform per episode rather than new machinery, and four
things change when it is done.
...
compared household-by-household rather than distribution-by-distribution. Third, the rulebook axis becomes exact: PolicyEngine's parameter
