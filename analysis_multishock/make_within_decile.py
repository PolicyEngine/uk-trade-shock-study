...
mean = [x["burden_pct_of_net_income_mean"] for x in r["by_decile"]]
p10 = [x["p10_burden_pct_income"] for x in r["within_decile_dispersion"]]
p90 = [x["p90_burden_pct_income"] for x in r["within_decile_dispersion"]]
bw = r["variance_decomposition"]["between_decile_share_pct"]
ww = r["variance_decomposition"]["within_decile_share_pct"]
...
ax.annotate(f"Between deciles: {bw:.0f}% of variance\nWithin deciles: {ww:.0f}%",
            ...
            linespacing=1.45)
fig.text(0.02, 0.055,
         "Bars are each decile's mean realised 2022-23 energy burden as a share of net income; whiskers span the\n"
         "10th-90th percentile of that burden among households in the same decile. Enhanced FRS in PolicyEngine UK.",
