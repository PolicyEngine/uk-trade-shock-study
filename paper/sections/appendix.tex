...
\section{Regional incidence}

\begin{figure}[htbp]
\centering
\includegraphics[width=.95\textwidth]{../results/figures/map_region_income_change.png}
\caption{Regenerated regional mean disposable-income changes under full and EPD displacement. Rankings are illustrative and the underlying spread is assignment dispersion.}
\label{fig:region-maps}
\end{figure}
...
\caption{Regenerated constituency illustration using the current per-person income-change fields. The map does not use observed constituency industry mix.}
