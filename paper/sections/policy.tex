...
Within the maintained direct-channel scenarios, the paired full-minus-EPD displacement contrast is $7{,}782\pm3{,}921$ workers, \pounds $0.377\pm0.263$ billion of gross earnings and \pounds $0.170\pm0.144$ billion of annual Exchequer cost. These SDs describe assignment dispersion and the contrasts are not causal estimates of the deal. Autos drive much of the difference; the scenario applies the in-quota rate to fixed exposure without modelling quota allocation or future above-quota trade.
