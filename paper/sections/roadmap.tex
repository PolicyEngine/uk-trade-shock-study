\subsection{Extending the household stage}\label{sec:roadmap}

Section~\ref{sec:results-secondstage} runs the three price-led
episodes through PolicyEngine UK on the enhanced Family Resources
Survey, and the tariff episode's earnings channel through the in-repository
pipeline. Carrying the tariff episode onto the same enhanced-FRS
records, and deepening the TCA and India runs beyond their price
vectors, would add episode-specific parameters to the same second
stage; this study has not implemented those runs, and four things
would change when it is done.
