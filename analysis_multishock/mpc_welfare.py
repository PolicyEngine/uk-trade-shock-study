...
Emits ../paper_multishock/generated_mpc.tex and table_mpc.tex.
"""
...
def main() -> None:
    ...
    with open("../paper_multishock/generated_mpc.tex", "w") as f:
    ...
    with open("../paper_multishock/table_mpc.tex", "w") as f:
        f.write("% generated by mpc_welfare.py -- do not edit by hand.\n")
