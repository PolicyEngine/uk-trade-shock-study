...
\TaaBreakEvenMonths\ months of faster re-employment, inside the observed
US range; and the UK's own historical design---ISERBS extended
from steel to all manufacturing---would cost \pounds\TaaIserbsCost\,million a year, less
than the US-style arm, giving a precedent-anchored starting point that
requires no imported blueprint.
