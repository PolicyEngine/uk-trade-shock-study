...
The first-pass results of Section~\ref{sec:results} run the declared
first stages against published expenditure-by-decile tables and
representative-worker statutory arithmetic. The full stage runs them
inside PolicyEngine UK on the enhanced Family Resources Survey, and four
things change.
