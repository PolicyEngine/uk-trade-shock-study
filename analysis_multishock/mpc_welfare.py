...
def main() -> None:
    ...
    with open("out/generated_mpc.tex", "w") as f:
    ...
    with open("out/table_mpc.tex", "w") as f:
        f.write("% generated by mpc_welfare.py -- do not edit by hand.\n")
    ...
    import shutil
    shutil.copy("out/generated_mpc.tex", "../paper_multishock/generated_mpc.tex")
    shutil.copy("out/table_mpc.tex", "../paper_multishock/table_mpc.tex")
